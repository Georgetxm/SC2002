...
/**
 * Represents a controller class that controls the relationships between
 * entities.
 * This class holds only the ids of entities and stores their links.
 * This controller is responsible for linking, delinking, and querying ids based
 * off each other.
 */
public interface Directory {
	...
	/**
	 * Sets the next get request to return only visible camps, if requesting for
	 * camps
	 * 
	 * @return itself
	 */
	...
	/**
	 * Gets the ids of all recorded entities of the specified type, subject to
	 * filters applied with with()
	 * 
	...
	/**
	 * Adds a new entity's id to the database. Ensures this entity can be linked
	 * with any other entity if needed
	 * 
	...
	/**
	 * Removes the links of all specified entities with each other, assuming a link
	 * exists
	 * 
